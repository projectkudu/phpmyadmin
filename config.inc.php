...
/**
 * This is the Azure env improvement where mysql connection string 
 * is either in environment variables or local file.
 * author: kududevs@microsoft.com
 * date: 11/11/2015
 */
